...
- **Every claim needs provenance.** Whatever this project asserts about a record has to trace back to the exact evidence and check that produced it. A signed fact, an absence the project noticed, and something merely inferred are different kinds of statement, and none should be presented as another.
